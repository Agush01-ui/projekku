...
<body>
    <div class="container">
        <!-- Product Image -->
        <div class="image">
            <img src="pr3.png" alt="Product Image" style="width: 100%; height: auto;">
        </div>
        ...
        <!-- Product Details -->
        <div class="details">
            <h1 class="product-title"  style="color: black; font-size: 30px" >Nike ZoomX</h1>
            <p class="rating"  style="color: black">⭐ 4.2 | <span  style="color: black">543 Reviews</span></p>
            <p class="price"  style="color: black">Rp<span id="price"  style="color: black">5.200.000</span></p>
            ...
            <p style="color: red; font-size: 20px">Total Harga: Rp<span id="total-price">5.200.000</span></p>
