...
<body>
    <div class="container">
        <!-- Product Image -->
        <div class="image">
            <img src="pr2.png" alt="Product Image" style="width: 100%; height: auto;">
        </div>
        ...
        <!-- Product Details -->
        <div class="details">
            <h1 class="product-title"  style="color: black; font-size: 30px" >Nike Air Force</h1>
            <p class="rating"  style="color: black">⭐ 4.2 | <span  style="color: black">413 Reviews</span></p>
            <p class="price"  style="color: black">Rp<span id="price"  style="color: black">21.000.000</span></p>
            ...
            <p style="color: red; font-size: 20px">Total Harga: Rp<span id="total-price">21.000.000</span></p>
...
<div id="paymentModal" class="modal">
  <div class="modal-content">
    ...
    <form id="paymentForm">
      ...
      <label for="payment-method" style="color: black">Metode Pembayaran:</label>
      ...
      <div>
        <input type="radio" id="reguler" name="shippingOption" value="5000" checked>
        <label for="reguler">Reguler (3-5 hari) - Rp 5.000</label>
      </div>
      <div>
        <input type="radio" id="express" name="shippingOption" value="8000">
        <label for="express">Express (1-2 hari) - Rp 8.000</label>
      </div>

      <!-- Biaya Layanan -->
      <div>
        <p>Biaya Layanan: <span id="serviceFee">Rp 2.000</span></p>
      </div>
      ...
      <!-- Tombol Konfirmasi -->
      <button type="button" id="confirmPayment">Konfirmasi Pembayaran</button>
    </form>
  </div>
</div>
