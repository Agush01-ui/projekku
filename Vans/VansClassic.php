...
<body>
    <div class="container">
        <!-- Product Image -->
        <div class="image">
            <img src="pr13.png" alt="Product Image" style="width: 100%; height: auto;">
        </div>
        ...
        <!-- Product Details -->
        <div class="details">
            <h1 class="product-title"  style="color: black; font-size: 30px" >Vans Classic Old</h1>
            <p class="rating"  style="color: black">⭐ 4.2 | <span  style="color: black">443 Reviews</span></p>
            <p class="price"  style="color: black">Rp<span id="price"  style="color: black">23.500.000</span></p>
            ...
            <p style="color: red; font-size: 20px">Total Harga: Rp<span id="total-price">23.500.000</span></p>
