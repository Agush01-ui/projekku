...
<body>
    <div class="container">
        <!-- Product Image -->
        <div class="image">
            <img src="pr15.png" alt="Product Image" style="width: 100%; height: auto;">
        </div>
        ...
        <div class="details">
            ...
            <p class="price"  style="color: black">Rp<span id="price"  style="color: black">9.200.000</span></p>
            ...
            <p style="color: red; font-size: 20px">Total Harga: Rp<span id="total-price">9.200.000</span></p>
